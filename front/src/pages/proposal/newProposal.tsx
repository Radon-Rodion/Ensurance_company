...
import { postProposalRequest } from "@/api/createRequests/createRequests";
...
const NewProposal = () => {
  ...
  const handleSubmit = (event) => {
    ...
    postProposalRequest(name, description, setSuccess);
  };
    ...
    <div className="background">
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit} className="form">
        ...
        <Form.Group controlId="description">
          ...
          <Form.Control required as="textarea" rows={5} value={description} onChange={createChangeProcessor(setDescription)} />
          <Form.Control.Feedback type="invalid">{localisation.invalidEnter}</Form.Control.Feedback>
        </Form.Group>
